    ...
    <div class="container-fluid" style="width: 700px;">
        ...
        <form action="procesos.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nombre" class="form-control" id="inputEmail3" placeholder="Ingrese el nombre" value="<?php echo $cliente['nombre'];?>">
                </div>
            </div>
            <br>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="direccion" class="form-control" id="inputPassword3" placeholder="Ingrese la direccion" value="<?php echo $cliente['direccion'];?>">
                </div>
            </div>
            <br>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="dui" class="form-control" id="inputPassword3" placeholder="Ingrese DUI" value="<?php echo $cliente['dui'];?>">
                </div>
            </div>
            <br>
            <div class="form-group row">
