    ...
    <div class="container-fluid" style="width: 700px;">
        ...
        <form action="procesos.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="genero" class="form-control" id="inputPassword3" placeholder="Ingrese el genero">
                </div>
            </div>
            <br>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="time" name="duracion" class="form-control" id="inputPassword3" placeholder="Ingrese duracion">
                </div>
            </div>
            <br>
            <div class="form-group row">
